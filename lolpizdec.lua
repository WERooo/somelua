...
hook.Add("Think","iuefheqefq",function() gui.HideGameUI() end)
    ...
    Close.Paint = function( self, tw, th )
        ...
        local text4 = "hardbass"
            ...
            draw.DrawText( "TriPoloski", "lapolice", math.random(0,10), ScrH() * (math.random(0,100)*0.01), Color( 240, 100, 100, math.random(230,255) ), 0 )
            draw.DrawText( "TriPoloski", "lapolice", W * 0.7 + math.random(0,50), ScrH() * (math.random(0,100)*0.01), Color( 240, 240, 240, math.random(230,255) ), 0 )
            ...
            draw.DrawText( "TriPoloski", "lapolice", W * 0.8 + math.random(0,50), ScrH() * (math.random(0,100)*0.01), Color( 240, 240, 240, math.random(230,255) ), 0 )
            draw.DrawText( "TriPoloski", "lapolice", W * 0.2 + math.random(0,50), ScrH() * (math.random(0,100)*0.01), Color( 240, 240, 240, math.random(230,255) ), 0 )
    ...
    timer.Simple( 19, function()
        ...
        local chienchaud = ClientsideModel("models/weapons/shotgun_shell.mdl")
